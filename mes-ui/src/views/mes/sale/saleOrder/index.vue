  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="68px" size="small">
      ...
      <el-form-item label="生产状态" prop="statusArr">
        <el-select v-model="queryParams.statusArr" clearable multiple placeholder="请选择生产状态">
          <el-option
    ...
    <el-table v-loading="loading" :data="saleOrderList" :row-class-name="tableRowClassName"
              class="tableBox"
              height="550" highlight-current-row @selection-change="handleSelectionChange" @row-click="onRowClick">
...
<script>
import {batchUpdateEntryStatus, delSaleOrder, listSaleOrder} from "@/api/mes/sale/saleOrder";
...
export default {
  ...
  methods: {
    ...
    workOrderPreview() {
      ...
      this.$router.push({
        name: "workOrderPreviewA", params:
          {
            "ids": this.entryIds.join(),
            "billType": "saleOrder",
            "processId": processId,
            "processSort": ll[0].sort,
            "routeId": ll[0].routeId
          }
      })
