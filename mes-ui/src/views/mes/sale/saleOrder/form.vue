<template>
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      <el-row>
        <el-col :span="6">
          <el-form-item label="订单编号" prop="number">
            <el-input v-model="form.number" :disabled="isDisabled" placeholder="请输入单号"/>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="客户" prop="customerId">
            <el-input v-model="form.customerName" :disabled="isDisabled" placeholder=""/>
      ...
      <el-row>
        ...
        <el-col :span="6">
          <el-form-item label="销售员" prop="userId">
            <el-input v-model="form.userName" :disabled="isDisabled" placeholder=""/>
        ...
        <el-col :span="12">
          <el-form-item label="备注" prop="remark">
            <el-input v-model="form.remark" :disabled="isDisabled" :rows="5" placeholder="请输入备注" type="textarea"/>
          </el-form-item>
        </el-col>
      </el-row>
      <!--      <el-row>-->
      ...
      <!--        </el-col>-->
      <!--      </el-row>-->
      <el-form-item v-show="false" label="源单信息" prop="sourceInfo">
        <el-input v-model="form.sourceInfo" placeholder="请输入内容" type="textarea"/>
      </el-form-item>
      <el-divider content-position="center">销售订单明细</el-divider>
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button :disabled="isDisabled" icon="el-icon-plus" size="mini" type="primary"
                     @click="handleAddSalOrderEntry">添加
          </el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button :disabled="isDisabled" icon="el-icon-delete" size="mini" type="danger"
                     @click="handleDeleteSalOrderEntry">删除
          </el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button :disabled="isDisabled" icon="el-icon-plus" size="mini" type="primary" @click="sortUp">上移
          </el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button :disabled="isDisabled" icon="el-icon-plus" size="mini" type="primary" @click="sortDown">下移
          </el-button>
        </el-col>
      </el-row>
      <el-table ref="salOrderEntry" :data="form.salOrderEntryList"
                class="tableBox" @selection-change="handleSalOrderEntrySelectionChange">
        <el-table-column align="center" type="selection" width="40"/>
        <!--  动态属性        -->
        <template v-for="(item,index) in entryFieldExtendList">
          <el-table-column :label="item.fieldName" :width="item.width+48" align="center" show-overflow-tooltip='true'>
            <template slot-scope="scope">
              <el-form-item :prop="'salOrderEntryList.'+scope.$index+'.'+formPropFormat(item)"
                            :rules="rules[item.field]"
                            label-width="0"
                            style="margin-bottom: 12px;"
              >
              <span v-if="item.type==='date'">
                  <el-date-picker v-model="scope.row[item.field]" clearable style="width: 140px" type="date"
                ...
                <span v-else-if="item.field==='materialName'">
                  <el-input v-model="scope.row.materialName" :disabled="isDisabled" placeholder="产品为必填项">
                    <el-button slot="append" :disabled="isDisabled" icon="el-icon-search"
...
<script>
import {addSaleOrder, getSaleOrder, updateSaleOrder} from "@/api/mes/sale/saleOrder";
