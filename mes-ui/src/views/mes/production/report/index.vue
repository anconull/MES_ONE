<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="reportList" class="tableBox" height="610px"
      ...
      <el-table-column align="center" class-name="small-padding fixed-width" label="操作" width="110">
        <template slot-scope="scope">
          <el-button
    ...
    <el-dialog
      ...
      <el-form ref="payRollPreviewForm" :model="payRollPreviewForm" :rules="rules" label-width="120">
        <el-table :data="payRollPreviewForm.list">
          ...
          <el-table-column align="center" label="工资单日期">
            <template slot-scope="scope">
              <el-form-item style="margin-bottom: 12px;">
                <el-date-picker v-model="scope.row.payrollDate"
                                clearable
          ...
          <el-table-column align="center" label="计价方案">
            <template slot-scope="scope">
              <el-form-item style="margin-bottom: 12px;">
                <el-input v-model="scope.row.planInfo" :disabled="true" :rows="1" type="textarea"/>
              </el-form-item>
            </template>
          </el-table-column>
          ...
          <el-table-column align="center" label="实发工资">
            <template slot-scope="scope">
              <el-form-item style="margin-bottom: 12px;">
          ...
          <el-table-column align="center" label="报工单">
            <template slot-scope="scope">
              <el-form-item style="margin-bottom: 12px;">
                <el-input v-model="scope.row.reportNumbers" :disabled="true" type="textarea"/>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column align="center" label="备注">
            <template slot-scope="scope">
              <el-form-item style="margin-bottom: 12px;">
                <el-input v-model="scope.row.remark" placeholder="请输入内容" type="textarea"/>
              </el-form-item>
            </template>
          </el-table-column>
        </el-table>
...
<script>
import {delReport, listReport} from "@/api/mes/production/report";
...
import {batchAdd, payRollPreview} from '@/api/mes/finance/payroll'
