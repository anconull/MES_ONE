<template>
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="68px" size="small">
      ...
      <el-form-item label="工序路线名称" label-width="100px" prop="name">
        <el-input
    ...
    <el-table v-loading="loading" :data="routeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="工序路线名称" prop="name"/>
      <el-table-column align="center" label="工序路线说明" prop="describes"/>
    ...
    <!-- 添加或修改工序路线对话框 -->
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" append-to-body width="750px">
      <el-form ref="form" :model="form" :rules="rules" class="jz-compact-form">
        ...
        <el-form-item label="工序路线说明" prop="describes">
          <el-input v-model="form.describes" placeholder="请输入内容" type="textarea"/>
        </el-form-item>
        <el-row :gutter="30" align="bottom" type="flex">
          <el-col :span="14">
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button icon="el-icon-plus" size="mini" type="primary" @click="handleAddProRouteProcess">添加</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button icon="el-icon-delete" size="mini" type="danger" @click="handleDeleteProRouteProcess">删除
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button icon="el-icon-plus" size="mini" type="primary" @click="sortUp">上移</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button icon="el-icon-plus" size="mini" type="primary" @click="sortDown">下移</el-button>
          </el-col>
        </el-row>
        <el-table ref="proRouteProcess"
                  :data="form.routeProcessList" @selection-change="handleProRouteProcessSelectionChange">
          ...
          <el-table-column label="工序" width="200">
            <template slot-scope="scope">
              <el-form-item :key="Math.random()" :prop="'routeProcessList.'+scope.$index+'.processId'"
                            :rules="rules.processId" label-width="0"
                            style="margin-bottom: 12px;">
                <el-select v-model="scope.row.processId" filterable placeholder="请选择"
                           @change="selectProcess($event,scope.row)">
                  <el-option
          ...
          <el-table-column label="首检数量">
            <template slot-scope="scope">
              <el-form-item :prop="'routeProcessList.'+scope.$index+'.firstQcQuantity'" :rules="rules.firstQcQuantity"
                            label-width="0"
                            style="margin-bottom: 12px;">
...
<script>
import {addRoute, delRoute, getRoute, listRoute, updateRoute} from "@/api/mes/production/route";
