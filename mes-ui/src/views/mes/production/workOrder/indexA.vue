  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="68px" size="small">
      ...
      <el-form-item label="工序" prop="processArr">
        <el-select v-model="queryParams.processArr" clearable multiple placeholder="请选择工序">
          <el-option
      ...
      <el-form-item label="设备" prop="equipmentArr">
        <el-select v-model="queryParams.equipmentArr" clearable multiple placeholder="请选择设备">
          <el-option
    ...
    <el-table v-loading="loading" :data="workOrderList" class="tableBox"
              height="500"
    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="领料排产" name="first">
        <el-table ref="pickEntryList" :data="pickEntryList"
                  :default-sort="{prop: 'sort'}"
                  style="">
          <el-table-column label="工序" prop="processName" width="150"/>
          <el-table-column align="center" label="领料仓库" prop="outWarehouseName" width="150"/>
          <el-table-column label="领取物料" prop="pickMaterialName" width="150"/>
          <el-table-column align="center" label="规格型号" prop="pickSpecification" width="150"/>
          <el-table-column align="center" label="领取数量" prop="pickQuantity" width="150"/>
        </el-table>
      </el-tab-pane>
      <el-tab-pane label="报工排产" name="second">
        <el-table ref="reportEntryList"
                  :data="reportEntryList"
                  :default-sort="{prop: 'sort'}"
                  style="">
          >
          <el-table-column label="工序" prop="processName" width="120"/>
          <el-table-column align="center" label="报工仓库" prop="inWarehouseName" width="120"/>
          <el-table-column label="报工物料" prop="reportMaterialName" width="150"/>
          <el-table-column align="center" label="规格型号" prop="reportSpecification" width="150"/>
          <el-table-column align="center" label="排产数量" prop="reportQuantity" width="150"/>
          <el-table-column align="center" label="工位" prop="stationName" width="150"/>
          <el-table-column align="center" label="设备" prop="machineName" width="150"/>
          <!--   子表自定义扩展字段     -->
...
<script>
import {delWorkOrder, editProStatus, listWorkOrder, updateCustomSort} from '@/api/mes/production/workOrder'
