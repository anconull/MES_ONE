...
<template>
  <keep-alive>
    <div class="app-container">
      <el-row>
        <div style="text-align: center;margin-bottom: 20px">排产工序：{{ process.name }}
          <el-button size="mini" style="margin-left: 20px" type="primary" @click="openProcessPlan">切换</el-button>
        </div>
        <!--  工单主表    -->
        <el-form ref="form" :model="form" :rules="rules" style="margin-top: 20px">
          <el-row>
            <el-col :span="4">
              <el-form-item :rules="rules.priority" label="优先级">
                <el-input-number v-model="form.priority" :max="10" :min="1"
                                 label="请输入数字，1为最高级"></el-input-number>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :rules="rules.materialName" label="产品" style="margin-left: 20px">
                <el-input v-model="form.materialName" placeholder="产品为必填项">
                  <el-button slot="append" icon="el-icon-search"
                             @click="handleSelectProduct(form)"></el-button>
                </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :rules="rules.specification" label="型号" style="margin-left: 20px"
              >
                <el-input v-model="form.specification"/>
              </el-form-item>
            </el-col>
            <el-col :span="4">
              <el-form-item :rules="rules.quantity" label="数量" style="margin-left: 20px"
              >
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item :rules="rules.planFinishDate" label="计划完成日期"
              >
                <el-date-picker v-model="form.planFinishDate" :clearable="false" style="width: 140px"
      ...
      <el-row>
        <el-dialog :visible.sync="dialogFormVisible" title="选择工序">
...
import {addWorkOrder, getWorkOrder, updateWorkOrder,} from '@/api/mes/production/workOrder'
