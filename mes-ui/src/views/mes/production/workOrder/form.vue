...
<template>
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      ...
      <el-row>
        <el-col :span="6">
          <el-form-item label="计划完工" prop="planFinishDate">
            <el-date-picker v-model="form.planFinishDate"
                            clearable
        ...
        <el-col :span="6">
          <el-form-item label="开始生产" prop="beginProDate">
            <el-date-picker v-model="form.beginProDate"
                            :disabled="true"
                            clearable
                            placeholder="暂未开始生产"
                            type="date"
        ...
        <el-col :span="6">
          <el-form-item label="实际完工" prop="realFinishDate">
            <el-date-picker v-model="form.realFinishDate"
                            :disabled="true"
                            clearable
                            placeholder="暂未完工"
                            type="date"
      ...
      <el-table ref="salOrderEntry" :data="form.workOrderEntryList">
        ...
        <el-table-column label="首检数量">
          <template slot-scope="scope">
            <el-form-item :prop="'workOrderEntryList.'+scope.$index+'.firstQcQuantity'" :rules="rules.firstQcQuantity"
                          label-width="0"
    ...
    <div slot="footer" class="dialog-footer">
      <el-button style="margin-left: 20px" type="primary" @click="submitForm">提 交</el-button>
    </div>
  </div>
</template>
