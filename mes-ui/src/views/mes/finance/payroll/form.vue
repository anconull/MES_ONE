<template>
  <!-- 添加或修改工资单对话框 -->
  <el-dialog :close-on-click-modal="false" :visible.sync="open" append-to-body title="工资单" width="500px">
    <el-form ref="form" :model="form" label-width="85px">
      ...
      <el-form-item label="状态">
        <dict-tag :disabled="true" :options="dict.type.bill_status" :value="form.status"/>
      </el-form-item>
...
<script>
import {listPayroll} from "@/api/mes/finance/payroll";
