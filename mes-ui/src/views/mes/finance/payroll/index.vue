<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="payrollList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="工资单日期" prop="payrollDate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.payrollDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="人员" prop="userName"/>
      <el-table-column align="center" label="应发工资" prop="shouldPay"/>
      <el-table-column align="center" label="实发工资" prop="realPay"/>
    ...
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="工资单编号" prop="number">
          <el-input v-model="form.number" :disabled="isDisabled" placeholder="不输入则由系统自动生成"/>
        </el-form-item>
        ...
        <el-form-item label="工资单日期" prop="payrollDate">
          <el-date-picker v-model="form.payrollDate"
                          clearable
...
<script>
import {addPayroll, delPayroll, getPayroll, listPayroll, updatePayroll} from "@/api/mes/finance/payroll";
