<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="bomoweihuList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="原料价格" prop="yuanliaojg"/>
      <el-table-column align="center" label="普通胶水价格" prop="jiaoshuijg"/>
      <el-table-column align="center" label="特殊胶水价格" prop="jiaoshuijgB"/>
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="原料价格" prop="yuanliaojg">
          <el-input v-model="form.yuanliaojg" placeholder="请输入原料价格" type="number"/>
        </el-form-item>
        <el-form-item label="普通胶水价格" prop="jiaoshuijg">
          <el-input v-model="form.jiaoshuijg" placeholder="请输入胶水价格" type="number"/>
        </el-form-item>
        <el-form-item label="特殊胶水价格" prop="jiaoshuijgB">
          <el-input v-model="form.jiaoshuijgB" placeholder="请输入胶水价格" type="number"/>
        </el-form-item>
      </el-form>
...
<script>
import {addBomoweihu, delBomoweihu, getBomoweihu, listBomoweihu, updateBomoweihu} from "@/api/mes/finance/bomoweihu";
