        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="120">
          <el-table :data="form.pieceWagePlanList" @selection-change="handleSelectionChange">
            ...
            <el-table-column align="center" label="物料名称" width="200">
              <template slot-scope="scope">
                <el-form-item :prop="'pieceWagePlanList.'+scope.$index+'.materialName'" :rules="rules.materialName"
                              label-width="240" style="margin-bottom: 12px;">
            ...
            <el-table-column align="center" label="岗位" width="120">
              <template slot-scope="scope">
                <el-form-item style="margin-bottom: 12px;">
                  <el-select v-model="scope.row.postId" :clearable="true" @change="postChange($event,scope.row)">
                    <el-option
...
<script>
import {delPieceWagePlan, getPieceWagePlan, listPieceWagePlan, savePieceWagePlan} from '@/api/mes/finance/pieceWagePlan'
