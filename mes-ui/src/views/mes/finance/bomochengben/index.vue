<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="bomochengbenList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="外贸基准价" prop="jizhunjiaWaimao" width="120"/>
      <el-table-column align="center" label="外贸不含税基准价" prop="jizhunjiaWaimaoB" width="140"/>
    ...
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" append-to-body width="980px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="外贸含税基准价" label-width="150px" prop="jizhunjiaWaimao">
              <el-input v-model="form.jizhunjiaWaimao" :disabled="true" placeholder=""/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="外贸不含税基准价" label-width="150px" prop="jizhunjiaWaimaoB">
              <el-input v-model="form.jizhunjiaWaimaoB" :disabled="true" placeholder=""/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-collapse>
