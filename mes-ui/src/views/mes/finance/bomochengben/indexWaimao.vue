  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="96px" size="small">
      ...
      <el-form-item label="核算方式" prop="priceType">
        <el-select v-model="queryParams.priceType" :clearable="true" @change="priceTypeChange">
          <el-option
...
<script>
import {
  addBomochengbenWaimao,
  delBomochengbenWaimao,
  getBomochengbenWaimao,
  listBomochengbenWaimao,
  updateBomochengbenWaimao
