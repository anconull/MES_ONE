<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="materialSnList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="SN码" prop="snCode" width="100"/>
      <el-table-column align="center" label="物料编号" prop="materialNumber" width="100"/>
      <el-table-column align="center" label="物料名称" prop="materialName" width="120"/>
      <el-table-column align="center" label="单位" prop="materialUnitName" width="55"/>
      <el-table-column align="center" label="批次编号" prop="batchNumber" width="100"/>
      <el-table-column align="center" label="条码内容" prop="content">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="规格型号" prop="specification">
          <el-input v-model="form.specification" placeholder="请输入内容" type="textarea"/>
        </el-form-item>
...
import {
  ...
  listMaterialSn,
  updateMaterialSn
} from "@/api/mes/barcode/materialSn";
