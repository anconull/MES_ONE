<template>
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="100px">
      ...
      <el-table ref="entryTable" :data="form.manufactureIntoEntryList" style="width: 100%"
        ...
        <el-table-column label="产品名" width="240">
          <template slot-scope="scope">
            <el-form-item :prop="'manufactureIntoEntryList.'+scope.$index+'.materialName'" :rules="rules.materialName"
        ...
        <el-table-column label="数量" width="120">
          <template slot-scope="scope">
            <el-form-item :prop="'manufactureIntoEntryList.'+scope.$index+'.quantity'" :rules="rules.quantity"
                          label-width="0"
        ...
        <el-table-column label="生产日期" prop="manufactureDate">
          <template slot-scope="scope">
            <el-form-item label-width="0" style="margin-bottom: 12px;">
              <el-date-picker v-model="scope.row.manufactureDate" clearable type="date" value-format="yyyy-MM-dd"/>
            </el-form-item>
          </template>
        </el-table-column>
      </el-table>
...
<script>
import {addManufactureInto, getManufactureInto, updateManufactureInto} from "@/api/mes/warehouse/manufactureInto";
