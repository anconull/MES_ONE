<template>
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="100px">
      ...
      <el-row>
        ...
        <el-col :span="6">
          <el-form-item label="总金额" prop="price">
            <el-input
              v-model="form.price" :disabled="true" placeholder=""/>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-table ref="entryTable" :data="form.procureIntoEntryList" style="width: 100%"
        ...
        <el-table-column label="产品名" width="240">
          <template slot-scope="scope">
            <el-form-item :prop="'procureIntoEntryList.'+scope.$index+'.materialName'" :rules="rules.materialName"
        ...
        <el-table-column label="数量" width="120">
          <template slot-scope="scope">
            <el-form-item :prop="'procureIntoEntryList.'+scope.$index+'.quantity'" :rules="rules.quantity"
                          label-width="0"
        ...
        <el-table-column label="单价" width="120">
          <template slot-scope="scope">
            <el-form-item :prop="'procureIntoEntryList.'+scope.$index+'.price'" label-width="0"
                          style="margin-bottom: 12px;">
        ...
        <el-table-column label="金额" width="120">
          <template slot-scope="scope">
            <el-form-item :prop="'procureIntoEntryList.'+scope.$index+'.totalPrice'" label-width="0"
                          style="margin-bottom: 12px;">
...
<script>
import {addProcureInto, getProcureInto, updateProcureInto} from "@/api/mes/warehouse/procureInto";
import {listUser} from '@/api/system/user'
import MaterialSelect from "@/components/mes/materialSelect.vue";
import {listWarehouse} from '@/api/mes/warehouse/warehouse'
import {listSupplier} from "@/api/mes/masterdata/supplier";
