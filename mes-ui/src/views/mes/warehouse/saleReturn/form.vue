<template>
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="入库日期" prop="intoDate">
            <el-date-picker v-model="form.intoDate"
                            clearable
                            placeholder="请选择领料时间"
                            type="date"
      ...
      <el-table ref="entryTable" :data="form.saleReturnEntryList" @selection-change="handleSelectionChange">
        ...
        <template v-for="(item,index) in entryFieldExtendList">
          <el-table-column :label="item.fieldName" :width="item.width+48" align="center" show-overflow-tooltip='true'>
            <template slot-scope="scope">
              <el-form-item :prop="'saleReturnEntryList.'+scope.$index+'.'+formPropFormat(item)"
...
import {addSaleReturn, getSaleReturn, updateSaleReturn} from "@/api/mes/warehouse/saleReturn";
