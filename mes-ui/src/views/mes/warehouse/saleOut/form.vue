  ...
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="仓库编号" prop="warehouseNumber">
            <el-input v-model="form.warehouseNumber" :disabled="true" placeholder="请输入仓库编号"/>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="客户" prop="customerName">
            <el-select v-model="form.customerName" clearable filterable placeholder="请选择客户"
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="物流信息">
            <el-input v-model="form.logisticsInfo" type="textarea"/>
          </el-form-item>
        </el-col>
        <el-col :span="8">
      ...
      <el-row>
        <el-col :span="6">
          <el-form-item label="总金额" prop="totalAmount">
            <el-input
              v-model="form.totalAmount" :disabled="true" placeholder=""/>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="10" class="mb8">
        ...
        <el-col :span="1.5">
          <el-button icon="el-icon-delete" size="mini" type="danger" @click="handleDeleteEntry">删除</el-button>
        </el-col>
        <el-col :span="1.5">
      ...
      <el-table ref="entryTable" :data="form.saleOutEntryList" class="tableBox"
        ...
        <template v-for="(item,index) in entryFieldExtendList">
          <el-table-column :label="item.fieldName" :width="item.width+48" align="center" show-overflow-tooltip='true'>
            <template slot-scope="scope">
              <el-form-item :prop="'saleOutEntryList.'+scope.$index+'.'+formPropFormat(item)" :rules="rules[item.field]"
                            label-width="0"
...
import {addSaleOut, getSaleOut, updateSaleOut} from "@/api/mes/warehouse/saleOut";
import {listCustomer} from "@/api/mes/masterdata/customer";
import {listFieldExtend} from "@/api/mes/system/fieldExtend";
import {listSaleOrder} from "@/api/mes/sale/saleOrder";
import {fieldFormat, formPropFormat} from '@/utils/jinzhong';
