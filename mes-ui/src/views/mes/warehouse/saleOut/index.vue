<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="saleOutList" class="tableBox" @selection-change="handleSelectionChange">
...
<script>
import {delSaleOut, listSaleOut} from "@/api/mes/warehouse/saleOut";
