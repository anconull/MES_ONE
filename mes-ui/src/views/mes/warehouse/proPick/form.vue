<template>
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="领料时间" prop="pickTime">
            <el-date-picker v-model="form.pickTime"
                            clearable
                            placeholder="请选择领料时间"
                            type="date"
        ...
        <el-col :span="8">
          <el-form-item label="领料人" prop="pickUserId">
            <el-select v-model="form.pickUserId" clearable filterable placeholder="请选择领料人"
                       @change="pickUserChange">
              <el-option
      ...
      <el-table ref="entryTable" :data="form.proPickEntryList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="产品名" width="240">
          <template slot-scope="scope">
            <el-form-item :prop="'proPickEntryList.'+scope.$index+'.materialName'" :rules="rules.materialName"
        ...
        <el-table-column label="数量" width="120">
          <template slot-scope="scope">
            <el-form-item :prop="'proPickEntryList.'+scope.$index+'.quantity'" :rules="rules.quantity" label-width="0"
...
<script>
import {addProPick, getProPick, updateProPick} from "@/api/mes/warehouse/proPick";
