<template>
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      ...
      <el-table ref="entryTable" :data="form.otherOutEntryList" class="tableBox"
        ...
        <el-table-column label="产品名" width="240">
          <template slot-scope="scope">
            <el-form-item :prop="'otherOutEntryList.'+scope.$index+'.materialName'" :rules="rules.materialName"
        ...
        <el-table-column label="数量" width="120">
          <template slot-scope="scope">
            <el-form-item :prop="'otherOutEntryList.'+scope.$index+'.quantity'" :rules="rules.quantity" label-width="0"
...
import {addOtherOut, getOtherOut, updateOtherOut} from "@/api/mes/warehouse/otherOut";
