  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="68px" size="small">
      ...
      <el-form-item label="设备类型" prop="type">
        <el-select v-model="queryParams.type" clearable placeholder="请选择设备类型">
          <el-option
    ...
    <el-col v-for="item in equipmentList" :span="6">
      <el-card
        :style="{'background-color': item.equipmentStatus=='A'?'#909399': item.equipmentStatus=='B'?'#E6A23C': item.equipmentStatus=='C'?'#67C23A':item.equipmentStatus=='D'?'#F56C6C':'#909399'}"
        class="box-card">
        <el-row>
          <el-col :span="4">
            <el-image
          ...
          <el-col :span="20" style="padding-left: 8px">
            ...
            <el-row style="margin-bottom: 4px">
              ...
              <el-col :span="6">
                <el-button plain round size="small" type="primary">OEE数据</el-button>
              </el-col>
            </el-row>
            <el-row style="margin-bottom: 4px">
              <el-col :span="8">
              ...
              <el-col :span="16">
                <dict-tag :options="dict.type.equipment_status" :value="item.equipmentStatus" size="mini"/>
              </el-col>
            ...
            <el-row style="margin-bottom: 4px">
              ...
              <el-col :span="4">
                <el-button round size="small" type="danger" @click="handleDelete(item)">删除</el-button>
              </el-col>
            </el-row>
          </el-col>
        </el-row>
...
<script>
import {addEquipment, delEquipment, getEquipment, listEquipment, updateEquipment} from "@/api/mes/equipment/equipment";
