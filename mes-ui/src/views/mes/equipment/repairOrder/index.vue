  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="68px" size="small">
      ...
      <el-form-item label="设备类型" prop="equipmentType">
        <el-select v-model="queryParams.equipmentType" clearable placeholder="请选择设备类型">
          <el-option
      ...
      <el-form-item label="处理结果" prop="repairResult">
        <el-select v-model="queryParams.repairResult" clearable placeholder="请选择处理结果">
          <el-option
      ...
      <el-form-item label="单据状态" prop="statusArr">
        <el-select v-model="queryParams.statusArr" clearable multiple placeholder="请选择处理结果">
          <el-option
    ...
    <el-table v-loading="loading" :data="repairOrderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="规格型号" prop="equipmentSpecification"/>
      ...
      <el-table-column align="center" label="报修时间" prop="reportRepairTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.reportRepairTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="维修完成时间" prop="finishTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.finishTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="维修人" prop="repairUserName"/>
      <el-table-column align="center" label="验收日期" prop="confirmTime" width="180">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="处理结果" prop="repairResult">
        <template slot-scope="scope">
    ...
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" append-to-body width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="报修时间" prop="reportRepairTime">
              <el-date-picker v-model="form.reportRepairTime"
                              clearable
                              placeholder="请选择报修时间"
                              type="datetime"
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="维修人" prop="repairUserId">
              <el-select v-model="form.repairUserId" clearable filterable placeholder="请选择"
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="验收人" prop="confirmUserId">
              <el-select v-model="form.confirmUserId" clearable filterable placeholder="请选择"
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button icon="el-icon-plus" size="mini" type="primary" @click="handleAddRepairOrderEntry">添加
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button icon="el-icon-delete" size="mini" type="danger" @click="handleDeleteRepairOrderEntry">删除
            </el-button>
          </el-col>
        </el-row>
        <el-table ref="repairOrderEntry" :data="repairOrderEntryList"
                  :row-class-name="rowRepairOrderEntryIndex" @selection-change="handleRepairOrderEntrySelectionChange">
          <el-table-column align="center" type="selection" width="50"/>
          <el-table-column align="center" label="序号" prop="index" width="50"/>
          <el-table-column label="项目" prop="itemId" width="150">
            <template slot-scope="scope">
              <el-select v-model="scope.row.itemId" placeholder="请选择" @change="itemSelectChange($event,scope.row)">
                <el-option
          ...
          <el-table-column label="项目类型" prop="itemType" width="80">
            <template slot-scope="scope">
              <dict-tag :options="dict.type.inspection_item_type" :value="scope.row.itemType"
...
import {
  ...
  listRepairOrder,
  updateRepairOrder
} from "@/api/mes/equipment/repairOrder";
