  ...
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="68px" size="small">
      <el-form-item label="所属车间" prop="workshopId">
        <el-select v-model="queryParams.workshopId" clearable placeholder="请选择车间">
          <el-option
    ...
    <el-table v-loading="loading" :data="stationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="所属车间" prop="workshopName"/>
      <el-table-column align="center" label="工位名称" prop="name"/>
      <el-table-column align="center" label="工位编号" prop="number"/>
      <el-table-column align="center" label="绑定工序" prop="processIds" width="230">
        <template slot-scope="scope">
          {{ processFormat(scope.row.processIds) }}
        </template>
      </el-table-column>
      <el-table-column align="center" label="绑定设备" prop="machineIds" width="230">
        <template slot-scope="scope">
    ...
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="所属车间" prop="workshopId">
          <el-select v-model="form.workshopId" placeholder="请选择车间" style="width:350px"
                     @change="workshopSelectChange">
            <el-option
              v-for="item in workshopOptions"
              :key="item.id"
              :label="item.name"
        ...
        <el-form-item label="绑定工序" prop="processId">
          <el-select v-model="form.processIds" multiple placeholder="请选择工序" style="width:350px">
            <el-option
        ...
        <el-form-item label="绑定设备" prop="machineIds">
          <el-select v-model="form.machineIds" multiple placeholder="请选择设备" style="width:350px">
            <el-option
...
<script>
import {addStation, delStation, getStation, listStation, updateStation} from "@/api/mes/masterdata/station";
