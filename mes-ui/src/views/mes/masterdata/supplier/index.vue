<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="supplierList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="名称" prop="name" width="220"/>
      <el-table-column align="center" label="编号" prop="number"/>
      <el-table-column align="center" label="电话" prop="phone"/>
      <el-table-column align="center" label="地址" prop="address"/>
      <el-table-column align="center" label="简介" prop="cusDescribe"/>
    ...
    <!-- 添加或修改客户对话框 -->
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" append-to-body width="1000px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          ...
          <el-col :span="16">
            <el-form-item label="简介" prop="cusDescribe">
              <el-input v-model="form.cusDescribe" placeholder="请输入内容" type="textarea"/>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row style="padding-bottom: 20px">
          <el-card class="box-card">
            ...
            <el-col :span="8">
              <el-form-item label="电话" label-width="100px" prop="contactsPhone">
...
<script>
import {addSupplier, delSupplier, getSupplier, listSupplier, updateSupplier} from "@/api/mes/masterdata/supplier";
