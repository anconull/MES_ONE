<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="workshopList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="车间名" prop="name"/>
      <el-table-column align="center" label="负责人" prop="person"/>
...
<script>
import {addWorkshop, delWorkshop, getWorkshop, listWorkshop, updateWorkshop} from "@/api/mes/masterdata/workshop";
