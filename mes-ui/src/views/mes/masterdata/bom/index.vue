<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="计量单位" prop="material.unit.name"/>
      <el-table-column align="center" label="版本号" prop="number"/>
    ...
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="上级物料" prop="parentId">
          <treeselect v-model="form.parentId" :disabled="disabledFlag" :normalizer="normalizer"
                      :options="bomOptions" placeholder="请选择上级物料"/>
        </el-form-item>
...
<script>
import {addBom, delBom, getBom, listBom, updateBom} from "@/api/mes/masterdata/bom";
