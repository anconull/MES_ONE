      ...
      <el-col :span="20" :xs="24">
        <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="68px"
          ...
          <el-form-item label="物料类型" prop="typeId">
            <el-select v-model="queryParams.typeId" clearable placeholder="请选择物料类型">
              <el-option
        ...
        <el-table v-loading="loading" :data="materialList" class="tableBox" @selection-change="handleSelectionChange">
          ...
          <el-table-column align="center" label="计量单位" prop="unitId">
            <template slot-scope="scope">
              {{ unitFormat(scope.row.unitId) }}
            </template>
          </el-table-column>
          <el-table-column align="center" label="物料类型" prop="typeId">
            <template slot-scope="scope">
    ...
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" append-to-body width="700px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="编号" prop="number">
              <el-input v-model="form.number" :disabled="disabledFlag" placeholder="请输入编号"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="状态" prop="status">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="物料分类" prop="classId">
              <treeselect v-model="form.classId" :normalizer="normalizer" :options="materialClassOptions"
                          placeholder="请输入物料分类"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="绑定工序路线" label-width="80" prop="routeId">
              <el-select v-model="form.routeId" clearable filterable placeholder="请绑定工序路线" style="width: 320px"
                         @change="routeChange">
                <el-option
      ...
      <el-steps :active="9" align-center>
        <el-step v-for="item in routeProcessList" :title="item.processName"></el-step>
      </el-steps>
...
<script>
import {addMaterial, delMaterial, getMaterial, listMaterial, updateMaterial} from "@/api/mes/masterdata/material";
import {getRoute, listRoute} from "@/api/mes/production/route";
