<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="sysUserStationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="车间" prop="workshopName"/>
      <el-table-column align="center" label="工位" prop="stationName"/>
      <el-table-column align="center" label="用户名" prop="userName"/>
      <el-table-column align="center" label="昵称" prop="nickName"/>
      <el-table-column align="center" label="操作人" prop="updateBy"/>
      <el-table-column align="center" label="操作时间" prop="updateTime" width="180">
...
import {
  ...
  getSysUserStation,
  listSysUserStation,
  updateSysUserStation
} from "@/api/mes/common/sysUserStation";
