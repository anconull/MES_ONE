<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="integrateDataSourceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column align="center" label="源单名称" prop="sourceBillName"/>
      <el-table-column align="center" label="源单内码" prop="sourceBillCode"/>
      <el-table-column align="center" label="集成方式" prop="integrationMode"/>
      <el-table-column align="center" label="请求地址" prop="requestAddress"/>
      <el-table-column align="center" label="用户名" prop="userName"/>
      <el-table-column align="center" label="密码" prop="password"/>
      <el-table-column align="center" label="账套码" prop="bookCode"/>
    ...
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" append-to-body width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="集成方式" prop="integrationMode">
              <el-select v-model="form.integrationMode" clearable placeholder="请选择">
                <el-option
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="令牌" prop="token">
              <el-input v-model="form.token" placeholder="请输入内容" type="textarea"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="密钥" prop="secretKey">
              <el-input v-model="form.secretKey" placeholder="请输入内容" type="textarea"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="集成厂商" prop="manufacturer">
              <el-select v-model="form.manufacturer" clearable placeholder="请选择">
                <el-option
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button icon="el-icon-plus" size="mini" type="primary" @click="handleAddInteDataSourceField">添加
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button icon="el-icon-delete" size="mini" type="danger" @click="handleDeleteInteDataSourceField">删除
            </el-button>
          </el-col>
        </el-row>
        <el-table ref="inteDataSourceField" :data="inteDataSourceFieldList"
                  :row-class-name="rowInteDataSourceFieldIndex"
                  @selection-change="handleInteDataSourceFieldSelectionChange">
...
<script>
import {
  addIntegrateDataSource,
  delIntegrateDataSource,
  getIntegrateDataSource,
  listIntegrateDataSource,
  testConnection,
  updateIntegrateDataSource
} from "@/api/mes/integration/integrateDataSource";
