  ...
  >
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        <el-form v-show="showSearch" :inline="true" :model="queryParams" label-width="68px" size="small">
        ...
        <el-table ref="singleTable" v-loading="loading" :data="materialList" highlight-current-row
                  max-height="350" @current-change="handleCurrentChange">
